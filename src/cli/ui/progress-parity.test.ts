 ...
 * symbols, column geometry and colours are the reference's, with one deliberate
 * departure: each column is now coloured on its own, so a plan task no longer
 * turns cyan merely because the active pipeline stage sits on its row. The
 * fixtures were re-captured from the production painter after that fix; the
 * only differences are the escapes around the column separator and that row.
 */
...
const attentionFrame = [
  ...
  "~[0m~[0m",
  "~[0mPLAN / 1 of 5 certified          ~[0m│~[0m TASK PIPELINE~[0m",
  "~[0m                                 ~[0m│~[0m ~[0m",
  "~[0m~[32m✓ 01  Recovery contracts         ~[0m~[0m│~[0m ~[32m✓ Preparing~[0m~[0m",
  "~[36m● 02  Answer command             ~[0m│~[0m ? Implementing · needs attention~[0m",
  "~[0m· 03  Terminal handoff           ~[0m│~[0m · Verifying~[0m",
  "~[0m· 04  Recovery guidance          ~[0m│~[0m · Standards review~[0m",
  "~[0m· 05  Documentation              ~[0m│~[0m · Plan review~[0m",
  "~[0m                                 ~[0m│~[0m · Completed~[0m",
  "~[0mSESSION session-42               ~[0m│~[0m ~[0m",
  "~[0mAttempt 1 · Docker               ~[0m│~[0m ~[0m",
  "~[0m~[0m",
...
const blockedFrame = [
  ...
  "~[0m                                 ~[0m│~[0m ~[0m",
  "~[0m~[32m✓ 01  Recovery contracts         ~[0m~[0m│~[0m ~[32m✓ Preparing~[0m~[0m",
  "~[36m● 02  Answer command             ~[0m│~[0m ~[32m✓ Implementing~[0m~[0m",
  "~[0m· 03  Terminal handoff           ~[0m│~[0m ~[32m✓ Verifying~[0m~[0m",
  "~[0m· 04  Recovery guidance          ~[0m│~[0m ~[31m! Standards review · 2 blockers~[0m",
  "~[0m· 05  Documentation              ~[0m│~[0m · Plan review~[0m",
  "~[0m                                 ~[0m│~[0m · Completed~[0m",
  "~[0mSESSION session-42               ~[0m│~[0m ~[0m",
  "~[0mAttempt 1 · Docker               ~[0m│~[0m ~[0m",
...
const certifiedFrame = [
  ...
  "~[0m~[0m",
  "~[0mPLAN / 2 of 5 certified          ~[0m│~[0m TASK PIPELINE~[0m",
  "~[0m                                 ~[0m│~[0m ~[0m",
  "~[0m~[32m✓ 01  Recovery contracts         ~[0m~[0m│~[0m ~[32m✓ Preparing~[0m~[0m",
  "~[0m~[32m✓ 02  Answer command             ~[0m~[0m│~[0m ~[32m✓ Implementing~[0m~[0m",
  "~[0m· 03  Terminal handoff           ~[0m│~[0m ~[32m✓ Verifying~[0m~[0m",
  "~[0m· 04  Recovery guidance          ~[0m│~[0m ~[32m✓ Standards review~[0m~[0m",
  "~[0m· 05  Documentation              ~[0m│~[0m ~[32m✓ Plan review~[0m~[0m",
  "~[0m                                 ~[0m│~[0m ~[32m✓ Completed~[0m~[0m",
  "~[0mSESSION session-42               ~[0m│~[0m ~[0m",
  "~[0mAttempt 1 · Docker               ~[0m│~[0m ~[0m",
  "~[0m~[0m",
...
const shimmeringFrame = [
  ...
  "~[36m● 02  Answer command             ~[0m│~[0m ~[32m✓ Implementing~[0m~[0m",
  "~[0m· 03  Terminal handoff           ~[0m│~[0m ~[32m✓ Verifying~[0m~[0m",
  "~[0m· 04  Recovery guidance          ~[0m│~[36m ~[38;5;67m●~[38;5;67m ~[38;5;67mS~[38;5;67mt~[38;5;67ma~[38;5;67mn~[38;5;67md~[38;5;67ma~[38;5;67mr~[38;5;67md~[38;5;67ms~[38;5;67m ~[38;5;67mr~[38;5;67me~[38;5;67mv~[38;5;67mi~[38;5;67me~[38;5;67mw~[36m~[0m",
  "~[0m· 05  Documentation              ~[0m│~[0m · Plan review~[0m",
  "~[0m                                 ~[0m│~[0m · Completed~[0m",
  "~[0mSESSION session-42               ~[0m│~[0m ~[0m",
  "~[0mAttempt 1 · Docker               ~[0m│~[0m ~[0m",
...
const expandedFrame = [
  ...
  "~[0m                                 ~[0m│~[0m ~[0m",
  "~[0m~[32m✓ 01  Recovery contracts         ~[0m~[0m│~[0m ~[32m✓ Preparing~[0m~[0m",
  "~[36m● 02  Answer command             ~[0m│~[36m ● Implementing~[0m",
  "~[0m· 03  Terminal handoff           ~[0m│~[0m · Verifying~[0m",
  "~[0m· 04  Recovery guidance          ~[0m│~[0m · Standards review~[0m",
  "~[0m· 05  Documentation              ~[0m│~[0m · Plan review~[0m",
  "~[0m                                 ~[0m│~[0m · Completed~[0m",
